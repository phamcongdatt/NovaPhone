...
<div class="mx-auto max-w-4xl rounded-2xl border border-white/10 bg-[#0b1523] p-6 shadow-xl">
    <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid gap-8 lg:grid-cols-2">
            ...
            <div class="space-y-5">
                <div>
                    <label for="badge" class="mb-2 block text-sm font-medium text-slate-300">Nhãn nổi bật (Badge) <span class="text-xs text-slate-500 font-normal ml-2">VD: Sản phẩm mới ra mắt</span></label>
                    <input type="text" id="badge" name="badge" value="{{ old('badge') }}" placeholder="Để trống nếu muốn ẩn"
                ...
                <div>
                    ...
                    <textarea id="title" name="title" rows="2" placeholder='VD: iPhone <span class="text-transparent">17 Pro Max</span>'
                              class="w-full rounded-xl border border-white/10 bg-black/20 px-4 py-2.5 text-sm font-mono text-white outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500">{{ old('title') }}</textarea>
                ...
                <div>
                    ...
                    <input type="text" id="highlights" name="highlights" value="{{ old('highlights') }}" placeholder="VD: Camera 200MP, S Pen, Pin 5000mAh"
                           class="w-full rounded-xl border border-white/10 bg-black/20 px-4 py-2.5 text-sm text-white outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="url" id="buy_url" name="buy_url" value="{{ old('buy_url') }}" placeholder="Để trống nếu muốn ẩn"
                               class="w-full rounded-xl border border-white/10 bg-black/20 px-4 py-2.5 text-sm text-white outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="url" id="detail_url" name="detail_url" value="{{ old('detail_url') }}" placeholder="Để trống nếu muốn ẩn"
                               class="w-full rounded-xl border border-white/10 bg-black/20 px-4 py-2.5 text-sm text-white outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
            ...
            <div class="space-y-5">
                <div class="rounded-xl border border-white/10 bg-white/[0.02] p-5">
                    <label for="image" class="mb-3 block text-sm font-bold text-white">Hình ảnh Banner (Bên phải) <span class="text-red-500">*</span></label>
                    ...
                    <p class="mt-2 text-xs text-slate-400">Nên dùng ảnh PNG nền trong suốt để có hiệu ứng đẹp nhất.</p>
