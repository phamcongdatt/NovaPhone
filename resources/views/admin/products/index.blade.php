...
<div class="overflow-x-auto rounded-2xl border border-white/5 bg-night-soft">
    ...
    <a href="{{ route('admin.products.show', $product) }}"
       class="flex size-8 items-center justify-center rounded-lg bg-white/5 text-gray-400 transition-all duration-200 hover:bg-cyan-500/20 hover:text-cyan-400"
       title="Xem chi tiết">
