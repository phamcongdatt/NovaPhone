    ...
    <header class="sticky top-0 z-50 border-b border-white/5 bg-night/85 backdrop-blur-xl">
        <div class="mx-auto flex h-16 max-w-7xl items-center gap-4 px-4 sm:px-6 lg:h-[68px] lg:gap-8">
            ...
            <div class="flex shrink-0 items-center gap-1 sm:gap-2">
                ...
                {{-- Tài khoản --}}
                <a href="{{ route('register') }}" class="group flex items-center gap-2 rounded-xl px-2.5 py-2 text-gray-400 transition-all duration-200 ease-in-out hover:bg-white/5 hover:text-white sm:px-3">
